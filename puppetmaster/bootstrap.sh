...
cp /vagrant/puppetmaster/puppet-enterprise-2016.4.2-el-6-x86_64.tar.gz /root
cd /root
tar zxf puppet-enterprise-2016.4.2-el-6-x86_64.tar.gz
cd puppet-enterprise-2016.4.2-el-6-x86_64
cp /vagrant/puppetmaster/my_answers ./pe.conf 
mkdir -p /opt/puppetlabs/server/apps
mkdir -p /etc/puppetlabs/puppetserver/
mkdir -p /opt/puppetlabs/server/apps/
./puppet-enterprise-installer -c /root/puppet-enterprise-2016.4.2-el-6-x86_64/pe.conf
